...
function App() {
  ...
  const [from, setFrom] = useState("usd");   // ✅ lowercase
  const [to, setTo] = useState("inr");        // ✅ lowercase
  ...
  const convert = () => {
    setConvertedAmount(
      parseFloat((amount * currencyInfo[to]).toFixed(2))  // ✅ fix decimals
    );
  };
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.pexels.com/photos/35408819/pexels-photo-35408819.jpeg')",
      }}
    >
